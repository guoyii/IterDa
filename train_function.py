     ...
     for epoch in range(args.epoch_num):
          ...
          for phase in ["train", "val"]:
               ...
               for i, batch in enumerate(dataloaders[phase]):
                    ...
                    loss = criterion(image_pred, image_full)
          ...
          if os.path.exists(args.optimizer_path + "/" + args.optimizer_name + "{}.pkl".format(epoch-1)):
               os.unlink(args.optimizer_path + "/" + args.optimizer_name + "{}.pkl".format(epoch-1))
